...
import { demoOrgs, demoExhibitions } from '../lib/demoData'
...
export default function DemoListPage() {
  ...
  const rows = demoExhibitions.map((exh) => ({ exhibition: exh, org: orgMap[exh.org_id] }))
            ...
            >
              ...
              <div>
                ...
                <div style={{
                  ...
                  {' · '}{exh.location}{' · '}{formatDateRange(exh.start_date, exh.end_date)}
                </div>
              </div>
